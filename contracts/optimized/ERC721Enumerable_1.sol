...
import "./ERC165_1.sol";
import "./ERC721_1.sol";
import "./IERC721Enumerable_1.sol";
 ...
 */
abstract contract ERC721Enumerable_1 is
    Context_1,
    ERC165_1,
    ERC721_1,
    IERC721Enumerable_1
{
        ...
        internal
    {
        ...
        uint256 lastTokenIndex = SafeMath_1.sub(_ownedTokens[from].length, 1);
    ...
    function _removeTokenFromAllTokensEnumeration(uint256 tokenId) internal {
        ...
        uint256 lastTokenIndex = SafeMath_1.sub(_allTokens.length, 1);
