...
import "./ERC721Full_1.sol";
import "./INiftyRegistry_1.sol";
import "./BuilderMaster_1.sol";

contract NiftyBuilderInstance_1 is ERC721Full_1 {
    //MODIFIERS
    ...
    // implementing total supply after removing erc721enumerable
    uint256 public totalSupply;

    //MAPPINGS

    //mappings for token Ids
    mapping(uint256 => Counters_1.Counter) public _numNiftyMinted;
    ...
    ) public ERC721Full_1(_name, _symbol) {
    ...
    function giftNiftyOptimized(
        address collector_address,
        uint256 niftyType,
        uint256 numEditions
    ) public onlyValidSender {
        //master for static calls
        BuilderMaster_1 bm = BuilderMaster_1(masterBuilderContract);
        // _numNiftyMinted[niftyType].increment(); //moving this into the loop below
        ...
        totalSupply = _numNiftyMinted[niftyType].current();
    }
}
