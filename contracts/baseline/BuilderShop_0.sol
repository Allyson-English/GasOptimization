...
import "./NiftyBuilderInstance_0.sol";

contract BuilderShop_0 {
    ...
    function createNewBuilderInstance(
    ...
    ) public returns (NiftyBuilderInstance_0 tokenAddress) {
        // <- must replace this !!!
        ...
        NiftyBuilderInstance_0 new_contract = new NiftyBuilderInstance_0(
            _name,
            _symbol,
            contractId,
            num_nifties,
